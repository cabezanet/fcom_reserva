...
class csv{
	...
	/*public function setErrorLugar($fila,$numFila){

		$this->errors['noexistelugar'][$numFila] = $fila;	
		
	}

	public function getErroresLugar(){

		return $this->errors['noexistelugar'];
